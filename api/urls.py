...
urlpatterns = [
    ...
    path("get-fav-products/", AllFavProduct.as_view(), name="allfavproduct"),
    path("add-product-fav/", AddFavoriteProduct.as_view(), name="addProductFav"),
    path("remove-fav-products/", RemoveFavProduct.as_view(), name="removefavproduct"),
    ...
    path("get-self-comments/", GetSelfComments.as_view(), name="getselfcomments"),
    ...
    path("get-proc-order/", GetProc.as_view(), name="getprocorder"),
    path("get-sent-order/", GetSent.as_view(), name="getsentorder"),
    path("get-waiting-order/", GetWaiting.as_view(), name="getwaitingorder"),
